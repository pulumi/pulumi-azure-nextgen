...
func NewSchema(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-nextgen:logic/latest:Schema"),
		},
		{
			Type: pulumi.String("azure-nextgen:logic/v20150801preview:Schema"),
		},
		{
			Type: pulumi.String("azure-nextgen:logic/v20180701preview:Schema"),
		},
		{
			Type: pulumi.String("azure-nextgen:logic/v20190501:Schema"),
		},
	})
	opts = append(opts, aliases)
	var resource Schema
	err := ctx.RegisterResource("azure-nextgen:logic/v20160601:Schema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchema(ctx *pulumi.Context,
	...
	var resource Schema
	err := ctx.ReadResource("azure-nextgen:logic/v20160601:Schema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
