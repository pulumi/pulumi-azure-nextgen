...
export interface ApiOperationArgs {
     ...
     * An entity containing request details.
     */
    readonly request?: pulumi.Input<inputs.apimanagement.v20190101.RequestContract>;
    /**
     ...
     * Array of Operation responses.
     */
    readonly responses?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20190101.ResponseContract>[]>;
    /**
     ...
     * Collection of URL template parameters.
     */
    readonly templateParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20190101.ParameterContract>[]>;
    /**
     * Relative URL template identifying the target resource for this operation. May include parameters. Example: /customers/{cid}/orders/{oid}/?date={date}
     */
