...
export interface ManagedClusterArgs {
    ...
    readonly addonProfiles?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.containerservice.v20200201.ManagedClusterAddonProfile>;
    }>;
    /**
     * Properties of the agent pool.
     */
    ...
    readonly identityProfile?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.containerservice.v20200201.ManagedClusterPropertiesIdentityProfile>;
    }>;
    /**
     * Version of Kubernetes specified when creating the managed cluster.
     */
