...
export interface PacketCaptureArgs {
    ...
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20171101.PacketCaptureFilter>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20171101.PacketCaptureStorageLocation>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
