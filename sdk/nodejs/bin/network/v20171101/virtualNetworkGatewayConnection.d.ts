...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * The IPSec Policies to be considered by this connection.
     */
    readonly ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20171101.IpsecPolicy>[]>;
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: pulumi.Input<inputs.network.v20171101.LocalNetworkGateway>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    readonly peer?: pulumi.Input<inputs.network.v20171101.SubResource>;
    /**
     ...
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway1: pulumi.Input<inputs.network.v20171101.VirtualNetworkGateway>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: pulumi.Input<inputs.network.v20171101.VirtualNetworkGateway>;
    /**
