...
export interface NetworkInterfaceArgs {
     ...
     * The DNS settings in network interface.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20171101.NetworkInterfaceDnsSettings>;
    /**
     * If the network interface is accelerated networking enabled.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20171101.NetworkInterfaceIPConfiguration>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference of a virtual machine.
     */
    readonly virtualMachine?: pulumi.Input<inputs.network.v20171101.SubResource>;
}
