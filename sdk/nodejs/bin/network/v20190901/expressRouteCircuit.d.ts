...
export interface ExpressRouteCircuitArgs {
     ...
     * The list of authorizations.
     */
    readonly authorizations?: pulumi.Input<pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitAuthorization>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    readonly expressRoutePort?: pulumi.Input<inputs.network.v20190901.SubResource>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The list of peerings.
     */
    readonly peerings?: pulumi.Input<pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitPeering>[]>;
    /**
     ...
     * The ServiceProviderProperties.
     */
    readonly serviceProviderProperties?: pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitServiceProviderProperties>;
    /**
     * The ServiceProviderProvisioningState state of the resource.
     */
     ...
     * The SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitSku>;
    /**
     * Resource tags.
     */
