...
class WebApplicationFirewallPolicy extends pulumi.CustomResource {
    constructor(name, argsOrState, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20181201:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20190201:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20190401:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20190601:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20190701:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20190801:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20191101:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20191201:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20200301:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20200401:WebApplicationFirewallPolicy" }, { type: "azurerm:network/v20200601:WebApplicationFirewallPolicy" }] };
...
/** @internal */
WebApplicationFirewallPolicy.__pulumiType = 'azurerm:network/v20190901:WebApplicationFirewallPolicy';
