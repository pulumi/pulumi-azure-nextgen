...
export interface PublicIPAddressArgs {
     ...
     * The DDoS protection custom policy associated with the public IP address.
     */
    readonly ddosSettings?: pulumi.Input<inputs.network.v20190201.DdosSettings>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20190201.PublicIPAddressDnsSettings>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The Public IP Prefix this Public IP Address should be allocated from.
     */
    readonly publicIPPrefix?: pulumi.Input<inputs.network.v20190201.SubResource>;
    /**
     ...
     * The public IP address SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20190201.PublicIPAddressSku>;
    /**
     * Resource tags.
     */
