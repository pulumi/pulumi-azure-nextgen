...
class VirtualNetworkGateway extends pulumi.CustomResource {
    constructor(name, argsOrState, opts) {
        ...
        if (!(opts && opts.id)) {
            ...
            if (!args || args.gatewayType === undefined) {
            ...
            if (!args || args.vpnType === undefined) {
...
/** @internal */
VirtualNetworkGateway.__pulumiType = 'azurerm:network/v20160901:VirtualNetworkGateway';
