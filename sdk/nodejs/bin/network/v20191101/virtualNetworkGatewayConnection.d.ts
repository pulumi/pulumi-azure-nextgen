...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: pulumi.Input<inputs.network.v20191101.LocalNetworkGateway>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    readonly peer?: pulumi.Input<inputs.network.v20191101.SubResource>;
    /**
     ...
     * The Traffic Selector Policies to be considered by this connection.
     */
    readonly trafficSelectorPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20191101.TrafficSelectorPolicy>[]>;
    /**
     * Enable policy-based traffic selectors.
     */
     ...
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway1: pulumi.Input<inputs.network.v20191101.VirtualNetworkGateway>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: pulumi.Input<inputs.network.v20191101.VirtualNetworkGateway>;
    /**
