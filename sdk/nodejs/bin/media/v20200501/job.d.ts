...
export declare class Job extends pulumi.CustomResource {
     ...
     */
    readonly input: pulumi.Output<outputs.media.v20200501.JobInputResponse>;
    /**
     ...
     */
    readonly outputs: pulumi.Output<outputs.media.v20200501.JobOutputResponse[]>;
    /**
...
export interface JobArgs {
     ...
     * The outputs for the Job.
     */
    readonly outputs: pulumi.Input<pulumi.Input<inputs.media.v20200501.JobOutput>[]>;
    /**
     * Priority with which the job should be processed. Higher priority jobs are processed before lower priority jobs. If not set, the default is normal.
     */
