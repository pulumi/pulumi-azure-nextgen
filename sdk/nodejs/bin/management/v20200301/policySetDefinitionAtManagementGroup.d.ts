...
export declare class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    readonly parameters: pulumi.Output<{
        [key: string]: outputs.management.v20200301.ParameterDefinitionsValueResponse;
    } | undefined>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups: pulumi.Output<outputs.management.v20200301.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Output<outputs.management.v20200301.PolicyDefinitionReferenceResponse[]>;
    /**
...
export interface PolicySetDefinitionAtManagementGroupArgs {
    ...
    readonly parameters?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.management.v20200301.ParameterDefinitionsValue>;
    }>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
