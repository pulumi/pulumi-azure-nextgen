...
describe("PushableAsyncIterable", () => {
    ...
    it("correctly produces multiple sequence", util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        queue.push(3);
        queue.complete();
        assert.deepEqual(yield enumerate(queue), [1, 2, 3]);
    })));
    it("correctly terminates outstanding operations afte complete", util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const terminates = new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
            assert.deepEqual(yield queueIter.next(), { value: undefined, done: true });
            assert.deepEqual(yield queueIter.next(), { value: undefined, done: true });
            assert.deepEqual(yield queueIter.next(), { value: undefined, done: true });
            resolve();
        }));
    ...
    it("correctly interleaves operations", util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        queue.push(1);
        queue.push(2);
        assert.deepEqual(yield queueIter.next(), { value: 1, done: false });
        queue.push(3);
        assert.deepEqual(yield queueIter.next(), { value: 2, done: false });
        assert.deepEqual(yield queueIter.next(), { value: 3, done: false });
        queue.push(4);
        queue.push(5);
        queue.push(6);
        queue.push(7);
        assert.deepEqual(yield queueIter.next(), { value: 4, done: false });
        assert.deepEqual(yield queueIter.next(), { value: 5, done: false });
        assert.deepEqual(yield queueIter.next(), { value: 6, done: false });
        assert.deepEqual(yield queueIter.next(), { value: 7, done: false });
        queue.complete();
        assert.deepEqual(yield queueIter.next(), { value: undefined, done: true });
    })));
});
